...
echo "============================================"
./ripd config/r1.cfg 2>/tmp/r1.log &
./ripd config/r2.cfg 2>/tmp/r2.log &
./ripd config/r3.cfg 2>/tmp/r3.log &
...
./ripd config/r1.cfg 2>/dev/null &
./ripd config/r2.cfg 2>/dev/null &
./ripd config/r3.cfg 2>/dev/null &
sleep 35
