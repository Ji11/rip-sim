...
```bash
./ripd config/r1.cfg    # 路由器 1 (UDP 5201, TCP 8021)
./ripd config/r2.cfg    # 路由器 2 (UDP 5202, TCP 8022)
./ripd config/r3.cfg    # 路由器 3 (UDP 5203, TCP 8023)
```
